      ...
      },
      {
        ...
        inputSchema: {
          ...
          properties: {
            ...
            allegation_type: {
              type: 'string',
              enum: ['rape', 'sexual_abuse', 'trafficking', 'associate', 'event_attendee', 'cleared', 'not_accused_by_giuffre', 'childhood_abuse'],
      ...
      },
      {
        ...
        inputSchema: {
          ...
          properties: {
            ...
            primary_doc_verified: { type: 'boolean', description: 'Whether verified by primary documents' },
      ...
      },
      {
        ...
        inputSchema: {
          ...
          properties: {
            ...
            source_type: {
              type: 'string',
              enum: ['primary_document', 'wire_service', 'major_news', 'tabloid', 'blog', 'social_media', 'wiki', 'state_media'],
            },
            credibility_tier: { type: 'number', description: 'Tier 1-5 (1=highest)' },
            known_bias: {
              type: 'string',
              enum: ['neutral', 'left', 'left_lean', 'right', 'right_lean', 'sensationalist', 'anti_western', 'unknown'],
            },
  ...
  try {
    switch (name) {
          ...
          return {
            content: [{
              ...
              text: JSON.stringify({
                domain,
                status: 'NOT_RATED',
                recommendation: 'This source has not been rated. Treat with caution and verify claims independently.',
              }),
            }],
          };
        }
      ...
      case 'list_cleared_individuals': {
        ...
        return {
          content: [{ type: 'text', text: JSON.stringify({ cleared_or_not_accused: result.rows }, null, 2) }],
        };
      }
