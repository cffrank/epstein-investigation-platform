...
import { FileText, GitBranch, Loader2, MessageCircle, Search, Users } from "@lucide/svelte";
...
const quickActions = [
	...
	},
	{
		...
		href: "/chat",
		icon: MessageCircle,
		description: "Ask questions with citations",
	},
	{
		label: "Graph Explorer",
		href: "/graph",
		icon: GitBranch,
		description: "Visual entity relationships",
	},
	{
